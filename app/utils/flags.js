...
const ALL_FLAGS = [
  { code: "sassy", name: "Sassy" },
  { code: "peace", name: "Peace" },
  { code: "pirate", name: "Pirate" },
  { code: "pride", name: "Pride" },
...
export const flagGroups = [
  {
    title: "Misc",
    data: ALL_FLAGS.filter((f) => MISC_CODES.has(f.code)),
  },
  {
    title: "Countries",
    data: ALL_FLAGS.filter(
      (f) => !MISC_CODES.has(f.code) && !f.code.startsWith("us-"),
    ),
  },
  {
    title: "US States",
    data: ALL_FLAGS.filter((f) => f.code.startsWith("us-")),
  },
];
