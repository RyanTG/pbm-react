...
const flagImages = {
  ...
  pride: require("../assets/images/flags/pride.png"),
  ...
  sassy: require("../assets/images/flags/sassy.png"),
  ...
  transgender: require("../assets/images/flags/transgender.png"),
  ...
  un: require("../assets/images/flags/un.png"),
  us: require("../assets/images/flags/us.png"),
  "us-ak": require("../assets/images/flags/us-ak.png"),
  "us-al": require("../assets/images/flags/us-al.png"),
  "us-ar": require("../assets/images/flags/us-ar.png"),
  "us-az": require("../assets/images/flags/us-az.png"),
  "us-ca": require("../assets/images/flags/us-ca.png"),
  "us-co": require("../assets/images/flags/us-co.png"),
  "us-ct": require("../assets/images/flags/us-ct.png"),
  "us-de": require("../assets/images/flags/us-de.png"),
  "us-fl": require("../assets/images/flags/us-fl.png"),
  "us-ga": require("../assets/images/flags/us-ga.png"),
  "us-hi": require("../assets/images/flags/us-hi.png"),
  "us-ia": require("../assets/images/flags/us-ia.png"),
  "us-id": require("../assets/images/flags/us-id.png"),
  "us-il": require("../assets/images/flags/us-il.png"),
  "us-in": require("../assets/images/flags/us-in.png"),
  "us-ks": require("../assets/images/flags/us-ks.png"),
  "us-ky": require("../assets/images/flags/us-ky.png"),
  "us-la": require("../assets/images/flags/us-la.png"),
  "us-ma": require("../assets/images/flags/us-ma.png"),
  "us-md": require("../assets/images/flags/us-md.png"),
  "us-me": require("../assets/images/flags/us-me.png"),
  "us-mi": require("../assets/images/flags/us-mi.png"),
  "us-mn": require("../assets/images/flags/us-mn.png"),
  "us-mo": require("../assets/images/flags/us-mo.png"),
  "us-ms": require("../assets/images/flags/us-ms.png"),
  "us-mt": require("../assets/images/flags/us-mt.png"),
  "us-nc": require("../assets/images/flags/us-nc.png"),
  "us-nd": require("../assets/images/flags/us-nd.png"),
  "us-ne": require("../assets/images/flags/us-ne.png"),
  "us-nh": require("../assets/images/flags/us-nh.png"),
  "us-nj": require("../assets/images/flags/us-nj.png"),
  "us-nm": require("../assets/images/flags/us-nm.png"),
  "us-nv": require("../assets/images/flags/us-nv.png"),
  "us-ny": require("../assets/images/flags/us-ny.png"),
  "us-oh": require("../assets/images/flags/us-oh.png"),
  "us-ok": require("../assets/images/flags/us-ok.png"),
  "us-or": require("../assets/images/flags/us-or.png"),
  "us-pa": require("../assets/images/flags/us-pa.png"),
  "us-ri": require("../assets/images/flags/us-ri.png"),
  "us-sc": require("../assets/images/flags/us-sc.png"),
  "us-sd": require("../assets/images/flags/us-sd.png"),
  "us-tn": require("../assets/images/flags/us-tn.png"),
  "us-tx": require("../assets/images/flags/us-tx.png"),
  "us-ut": require("../assets/images/flags/us-ut.png"),
  "us-va": require("../assets/images/flags/us-va.png"),
  "us-vt": require("../assets/images/flags/us-vt.png"),
  "us-wa": require("../assets/images/flags/us-wa.png"),
  "us-wi": require("../assets/images/flags/us-wi.png"),
  "us-wv": require("../assets/images/flags/us-wv.png"),
  "us-wy": require("../assets/images/flags/us-wy.png"),
...
export function getFlagWidth(code, height) {
  const source = flagImages[code];
  if (!source) return height * 1.5;
  const { width: natW, height: natH } = RNImage.resolveAssetSource(source);
  return (height * natW) / natH;
}
